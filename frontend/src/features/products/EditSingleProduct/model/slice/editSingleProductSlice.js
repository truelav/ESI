...
const editSingleProductSlice = createSlice({
    ...
    reducers: {
        ...
        removeImage: (state, action) => {
            state.formData.images = state.formData.images.filter((image) => image !== action.payload);
        },
        clearImages: (state) => {
...
export const { setProductData, setBrand, setModel, setDescription, setPrice, setQuantity, setUpc, addImage, removeImage, clearImages, setImages, clearFormData, } = editSingleProductSlice.actions;
