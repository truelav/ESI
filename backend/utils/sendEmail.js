...
export const sendResetPasswordEmail = (userEmail, userName, link) => {
  htmlContent = `
<!DOCTYPE html>
<html lang="en-US">
  <head>
...
export const sendConfirmResetPasswordEmail = (userEmail, userName, link) => {
  htmlContent = `
<!DOCTYPE html>
<html lang="en-US">
  <head>
...
export const sendEmailVerificationEmail = (userEmail, userName, link) => {
  htmlContent = `
<!DOCTYPE html>
<html lang="en-US">
  <head>
